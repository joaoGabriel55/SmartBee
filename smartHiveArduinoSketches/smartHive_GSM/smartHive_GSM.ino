...
float calibration_factor = 21600; // fator de calibração aferido na Calibraçao
...
void loop()
{
  ...
  if ( actionState == AS_IDLE ) {
    if ( now > lastActionTime + 5000 ) {
      ...
      sprintf(message_url, "AT+HTTPPARA=\"URL\",\"jquaresmasantos-98.000webhostapp.com/index.php?temp=%d&weight=%d\"", temperature, peso);
      sendGSM(message_url);
